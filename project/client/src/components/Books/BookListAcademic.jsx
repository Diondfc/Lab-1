    ...
    <div className="min-h-screen bg-gray-50">
      <div className="relative bg-gradient-to-br from-[#00509D] to-[#90CAF9] text-white">
        <div className="container mx-auto flex flex-col items-center px-4 py-20 text-center">
          ...
          <p className="mb-8 max-w-2xl text-xl opacity-90">
            Explore our comprehensive collection of academic resources and educational materials
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="mb-10 flex flex-col items-center justify-between gap-4 md:flex-row">
          <div>
            <h2 className="text-3xl font-bold text-[#036280]">Academic Books</h2>
            <p className="text-gray-600">{filteredBooks.length} books available in our collection</p>
          </div>
          <div className="relative w-full md:w-96">
            ...
            <input
              ...
              className="h-12 w-full rounded-lg border border-gray-300 pl-10 pr-4 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-[#036280]"
        ...
        {currentBooks.length > 0 ? (
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between">
                        <button
                          ...
                          className="flex items-center text-sm font-medium text-[#036280] hover:text-[#233B7D] hover:underline"
                        >
          ...
          <div className="rounded-lg border border-gray-100 bg-white py-12 text-center shadow-sm">
            <FiSearch className="mx-auto mb-3 text-4xl text-gray-300" />
...
export default BookListAcademic

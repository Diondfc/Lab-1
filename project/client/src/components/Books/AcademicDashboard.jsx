...
const AcademicDashboard = () => {
  ...
  const fetchAcademicBooks = async () => {
    try {
      ...
      console.error('Error fetching academic books:', err)
      setLoading(false)
    }
  }
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        <div>
          <h1 className="text-3xl font-bold text-[#036280] flex items-center gap-2">
            <FiBook className="text-3xl" />
            Academic Books List
          </h1>
          <p className="text-gray-500 mt-1">
            {books.length} books available in our academic collection
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
          ...
          <div className="relative max-w-xs w-full">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-[#036280] focus:border-transparent"
              placeholder="Search books..."
            />
          </div>
          <button
            onClick={() => navigate('/admin')}
            className="flex items-center text-[#036280] hover:text-[#024b63] transition"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="text-2xl font-bold text-[#036280]">{books.length}</div>
          </div>
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                      ...
                      <div className="ml-4">
                        ...
                        {book.description && (
                          <button 
                            ...
                            className="text-xs text-[#036280] hover:underline mt-1 flex items-center"
                          >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-right">
                    <div className="flex justify-end gap-2">
                      <button
                        ...
                        className="p-2 text-[#036280] hover:bg-[#036280]/10 rounded-lg transition"
                        title="Edit"
                      >
                        <FiEdit2 />
                      </button>
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-400 mt-1">
            {searchTerm 
              ...
              : "There are currently no academic books in the collection."}
          </p>
        </div>
      )}
    </div>
